...
const registerContent = function(filename) {
  const path = 'app/content/html/' + filename + '.html';
...
handlebars.registerPartial(
  'header',
  fs.readFileSync('app/content/html/header.html', 'utf8')
);
handlebars.registerPartial(
  'footer',
  fs.readFileSync('app/content/html/footer.html', 'utf8')
);
handlebars.registerPartial(
  'meta',
  fs.readFileSync('app/content/html/meta.html', 'utf8')
);
handlebars.registerPartial(
  'styles',
